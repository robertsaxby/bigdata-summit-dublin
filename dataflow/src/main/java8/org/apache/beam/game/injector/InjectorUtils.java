...
class InjectorUtils {
  ...
  /**
   * Builds and returns new Pub/Sub client
   */
    ...
    if (credential.getClientAuthentication() != null) {
      System.out.println(
          "\n***Warning! You are not using service account credentials to "
              ...
              + "\nsince user-level credentials do not have enough Pub/Sub quota,\nand so you will run "
  ...
  /**
   * Builds a new Pub/Sub client with default HttpTransport and JsonFactory and returns it.
   */
